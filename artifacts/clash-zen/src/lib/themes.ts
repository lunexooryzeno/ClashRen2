...
export type ThemeCategory = "esports" | "aggressive" | "atmospheric" | "clean" | "culture" | "classic";
...
export const CATEGORY_META: Record<ThemeCategory, { label: string; emoji: string }> = {
  esports:     { label: "Core Esports",  emoji: "⚡" },
  aggressive:  { label: "High-Energy",   emoji: "🔥" },
  atmospheric: { label: "Atmospheric",   emoji: "🌌" },
  clean:       { label: "Clean UI",      emoji: "🎯" },
  culture:     { label: "Culture",       emoji: "🎮" },
  classic:     { label: "Classics",      emoji: "⭐" },
};

export const THEME_CATALOG: ThemeEntry[] = [
  /* ── CORE ESPORTS ─────────────────────────────────────────────── */
  { id: "cyberpunk",         name: "Cyberpunk",            tagline: "Neon-drenched streets. Chrome dreams. No rules.",      bg: "#050408", accent: "#f0e018", accent2: "#ff2d6e", category: "esports",     tier: "free" },
  { id: "synthwave",         name: "Synthwave",             tagline: "Outrun the grid. The 80s never died.",                 bg: "#0d0018", accent: "#ff00ff", accent2: "#7700ff", category: "esports",     tier: "free" },
  { id: "neo-tokyo",         name: "Neo-Tokyo",             tagline: "The future is red. Drop in and dominate.",             bg: "#080008", accent: "#ff0040", accent2: "#ffffff", category: "esports",     tier: "free" },
  ...
  { id: "glitchcore",        name: "Glitchcore",            tagline: "Reality corrupted. System override.",                  bg: "#050005", accent: "#ff00ff", accent2: "#00ffff", category: "esports",     tier: "premium" },
  { id: "vaporwave",         name: "Vaporwave",             tagline: "Aesthetic overload. Chill vibes, deadly aim.",         bg: "#0f0318", accent: "#ff6ec7", accent2: "#a855f7", category: "esports",     tier: "free" },
  ...
  { id: "inferno",           name: "Inferno",               tagline: "Turn up the heat. Leave nothing but ash.",             bg: "#080000", accent: "#ff4500", accent2: "#ff8c00", category: "aggressive",  tier: "free" },
  ...
  { id: "neon-abyss",        name: "Neon Abyss",            tagline: "Dive into the dark. Neon lights the way down.",        bg: "#06000e", accent: "#9d4edd", accent2: "#c77dff", category: "aggressive",  tier: "premium" },
  ...
  { id: "rampage",           name: "Rampage / Frenzy",      tagline: "Rage mode activated. Nothing's stopping you.",         bg: "#060002", accent: "#dc143c", accent2: "#ff1a4e", category: "aggressive",  tier: "premium" },
  ...
  { id: "phantom",           name: "Phantom / Spectral",    tagline: "You can't catch what you can't see.",                  bg: "#030510", accent: "#7fffd4", accent2: "#00ced1", category: "atmospheric", tier: "premium" },
  { id: "deep-ocean",        name: "Deep Ocean",            tagline: "Pressure builds legends. Breathe.",                   bg: "#010810", accent: "#0891b2", accent2: "#38bdf8", category: "atmospheric", tier: "free" },
  { id: "crystalline",       name: "Crystalline",           tagline: "Sharp. Clear. Unbreakable.",                           bg: "#030a14", accent: "#a5f3fc", accent2: "#67e8f9", category: "atmospheric", tier: "free" },
  ...
  { id: "plasma",            name: "Plasma",                tagline: "Pure energy. No containment.",                         bg: "#060010", accent: "#e879f9", accent2: "#c026d3", category: "atmospheric", tier: "premium" },
  ...
  { id: "aurora",            name: "Aurora",                tagline: "Dance of light. Silence of focus.",                   bg: "#010612", accent: "#4ade80", accent2: "#ec4899", category: "atmospheric", tier: "premium" },
  ...
  { id: "glass",             name: "Glassmorphism",         tagline: "See through the chaos. Pure clarity.",                 bg: "#060612", accent: "#38bdf8", accent2: "#0ea5e9", category: "clean",       tier: "free" },
  { id: "dark",              name: "Dark Mode Pro",         tagline: "No fluff. Just precision.",                            bg: "#0e0e12", accent: "#a0a0b8", accent2: "#6060a0", category: "clean",       tier: "free" },
  { id: "ice",               name: "Ice / Glacier",         tagline: "Coolest player in the lobby. Always.",                 bg: "#020e1c", accent: "#bae6fd", accent2: "#7dd3fc", category: "clean",       tier: "free" },
  ...
  { id: "gridrunner",        name: "Gridrunner",            tagline: "On the grid. In the zone. Unstoppable.",               bg: "#010810", accent: "#00d4ff", accent2: "#0097b2", category: "clean",       tier: "premium" },
  ...
  { id: "battle-royale",     name: "Battle Royale",         tagline: "One server. One hundred players. You survive.",        bg: "#080400", accent: "#ea580c", accent2: "#dc2626", category: "culture",     tier: "free" },
  { id: "faction",           name: "Faction Wars",          tagline: "Pick a side. Fight for your clan.",                    bg: "#060410", accent: "#ef4444", accent2: "#3b82f6", category: "culture",     tier: "premium" },
  ...
  { id: "rhythm",            name: "Rhythm / Music",        tagline: "Hit the beat. Hit the squad.",                         bg: "#060010", accent: "#ec4899", accent2: "#a855f7", category: "culture",     tier: "premium" },
  ...
  /* ── CLASSICS ─────────────────────────────────────────────────── */
  { id: "molten",            name: "Molten Volcanic",       tagline: "Forge your legacy in fire. The OG loadout.",           bg: "#020202", accent: "#ea580c", accent2: "#dc2626", category: "classic",     tier: "free" },
  { id: "neon",              name: "Neon Cyber",            tagline: "Electric cyan. Magenta rage. Cyber domination.",       bg: "#06040a", accent: "#00ffff", accent2: "#c026d3", category: "classic",     tier: "free" },
  ...
  { id: "royal",             name: "Royal Gold",            tagline: "Only kings use this loadout.",                         bg: "#060812", accent: "#eab308", accent2: "#1d4ed8", category: "classic",     tier: "free" },
...
export const ALL_CATEGORY_KEYS = ["all", "esports", "aggressive", "atmospheric", "clean", "culture", "classic"] as const;
