...
export default function GetStartedPage() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col relative overflow-hidden bg-black">
      {/* Background glows */}
      <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[400px] bg-primary/15 rounded-full blur-[120px]" />
      <div className="pointer-events-none absolute bottom-0 right-0 w-[300px] h-[300px] bg-red-900/20 rounded-full blur-[100px]" />
      <div className="pointer-events-none absolute bottom-1/4 left-0 w-[200px] h-[200px] bg-purple-900/20 rounded-full blur-[80px]" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16 relative z-10">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className="w-20 h-20 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center shadow-[0_0_40px_rgba(139,92,246,0.25),0_0_0_1px_rgba(255,255,255,0.05)]">
            <img src={LOGO_URL} alt="Clash Ren Logo" className="w-13 h-13 object-contain" style={{ width: 52, height: 52 }} />
          </div>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              >
                ...
                <div className="w-full space-y-3">
                  <Button
                    type="submit"
                    className="w-full h-12 rounded-2xl bg-primary hover:bg-primary/90 text-white font-bold text-base shadow-[0_0_20px_rgba(139,92,246,0.4)] transition-all active:scale-95 font-heading tracking-wide"
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="w-full text-zinc-600 hover:text-zinc-400 text-xs"
