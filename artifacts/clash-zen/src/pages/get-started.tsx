          ...
          <AnimatePresence mode="wait">
            ...
            {step === "suspended" && suspendedData ? (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => { haptic.mediumTap(); window.location.href = "/api/auth/google"; }}
                  className="w-full flex items-center justify-center gap-3 rounded-2xl font-bold text-sm text-white transition-all active:scale-[0.98] hover:brightness-110"
                  style={{ height: 52, background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.15)", boxShadow: "0 2px 12px rgba(0,0,0,0.3)" }}
                >
                  ...
                  <span className="ml-auto text-[10px] font-bold px-2 py-0.5 rounded-full" style={{ background: "rgba(139,92,246,0.2)", color: "rgba(167,139,250,0.9)" }}>EXPLORE FREE</span>
                </button>
